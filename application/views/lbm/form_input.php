				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="nama_barang" id="nama_barang" pattern="[a-zA-Z0-9\s]+" placeholder="nama barang" value="" required />
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" name="harga" id="harga" pattern="[0-9]+" class="form-control" placeholder="Harga Barang" required>
							<span class="input-group-addon">
