				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="nama_barang" pattern="[a-zA-Z0-9\s]+" id="nama_barang" value="<?php echo $record['nama_barang'] ?>" placeholder="nama barang" value="" required />
