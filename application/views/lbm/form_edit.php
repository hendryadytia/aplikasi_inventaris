                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="pemilik" id="pemilik"
                                placeholder="nama pemilik" value="<?php echo $record['pemilik'] ?>" required />
                            <span class="input-group-addon">
                                <span class="fa fa-cube"></span>
                            </span>
                        </div>
                        ...
                        <div class="input-group">
                            <select name="id_kerusakan" class="form-control">
								...
								foreach ($kategori as $k) {
									if ($record['id_kerusakan'] == $k->id_kategori) {
                    ...
                    <div class="form-group input-daterange">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="tgl_masuk" id="tgl_masuk"
                                data-error="Tanggal masuk harus diisi" value="<?php echo $record['tgl_masuk'] ?>"
                                required />
                            <span class="input-group-addon">
